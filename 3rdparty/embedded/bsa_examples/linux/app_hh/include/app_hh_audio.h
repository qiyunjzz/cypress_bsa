...
/* For Google Voice, it uses 8K sample rate */
#define APP_HH_AUDIO_SAMPLE_RATE            8000
#define APP_HH_GOOGLE_AUDIO_REPORT_ID0      0xF7
#define APP_HH_GOOGLE_AUDIO_REPORT_ID1      0xFA
#define APP_HH_GOOGLE_AUDIO_REPORT_ID2      0xFB
#define APP_HH_AUDIO_DATA_SIZE0             17
#define APP_HH_AUDIO_DATA_SIZE1             20
#define APP_HH_AUDIO_DATA_SIZE2             20

#else
#define APP_HH_AUDIO_SAMPLE_RATE            16000
#define APP_HH_AUDIO_DATA_SIZE0             18
#define APP_HH_AUDIO_DATA_SIZE1             20
#define APP_HH_AUDIO_DATA_SIZE2             19
