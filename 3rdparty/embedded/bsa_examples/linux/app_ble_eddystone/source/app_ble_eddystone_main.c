...
enum
{
    ...
    APP_BLE_EDDYSTONE_ENABLE_PRIVACY,
    APP_BLE_EDDYSTONE_DISABLE_PRIVACY,
...
void app_ble_eddystone_display_menu (void)
{
    ...
    APP_INFO1("\t%d => Enable LE Privacy", APP_BLE_EDDYSTONE_ENABLE_PRIVACY);
    APP_INFO1("\t%d => Disable LE Privacy", APP_BLE_EDDYSTONE_DISABLE_PRIVACY);
...
void app_ble_eddystone_menu(void)
{
    ...
    do
    {
       ...
       case APP_BLE_EDDYSTONE_SEND_DATA2_EDDYSTONE_SERVER:
        ...
        case APP_BLE_EDDYSTONE_ENABLE_PRIVACY:
            app_dm_set_ble_local_privacy(TRUE);
            break;

        case APP_BLE_EDDYSTONE_DISABLE_PRIVACY:
